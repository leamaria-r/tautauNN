...
sample_sets = {
    ...
    "ggf_2024": [
        #res1-2b
        Sample("ggHH_kl_1_kt_1_c2_0_hbbhtt", year="2024", category="res[1,2]b", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=1),
        Sample("ggHH_kl_0_kt_1_c2_0_hbbhtt", year="2024", category="res[1,2]b", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=0),
        Sample("ggHH_kl_2p45_kt_1_c2_0_hbbhtt", year="2024", category="res[1,2]b", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=2.45),
        Sample("ggHH_kl_5_kt_1_c2_0_hbbhtt", year="2024", category="res[1,2]b", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=5),
        ...
        #boosted
        Sample("ggHH_kl_1_kt_1_c2_0_hbbhtt", year="2024", category="boosted", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=1),
        Sample("ggHH_kl_0_kt_1_c2_0_hbbhtt", year="2024", category="boosted", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=0),
        Sample("ggHH_kl_2p45_kt_1_c2_0_hbbhtt", year="2024", category="boosted", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=2.45),
        Sample("ggHH_kl_5_kt_1_c2_0_hbbhtt", year="2024", category="boosted", version="Prod_26_04", label=0, spin=0, mass=250.0, kl=5),
